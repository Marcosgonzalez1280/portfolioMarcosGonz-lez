...
<body>
  <header class="header">
        <div style="display: flex; align-items: center;">
            ...
            <h2 id="user-name">Página de Técnicos</h2>
        </div>
        <button onclick="window.location.href='logout.php'">Cerrar sesión</button>
    </header>

    <main class="tecnicos-wrapper">
        <h1>Buscador de Protocolos</h1>
        ...
        <!-- BOTÓN SOLO PARA NIVEL N2 -->
        <?php if ($nivel === 'n2'): ?>
        <section class="extra-actions">
            <button onclick="window.location.href='cordinacion.html'">Ir a Coordinación</button>
        </section>
        <?php endif; ?>
    </main>
